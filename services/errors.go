...
var (
	...
	// ErrGwemix is returned when gwemix
	// errors on a request.
	ErrGwemix = &types.Error{
		Code:    2, //nolint
		Message: "gwemix error",
	}
	...
	// ErrGwemixNotReady is returned when gwemix
	// cannot yet serve any queries.
	ErrGwemixNotReady = &types.Error{
		Code:      13, //nolint
		Message:   "gwemix not ready",
		Retriable: true,
	}
