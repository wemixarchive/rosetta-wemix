...
// Status returns gwemix status information
...
func (ec *Client) getBlock(
	...
	*types.Block,
	...
	// concurrent traces that are computed to 16 to avoid overwhelming gwemix).
	var traces []*rpcCall
...
func (ec *Client) Call(
	...
	case "eth_getTransactionReceipt":
		...
		// We cannot use RosettaTypes.MarshalMap because gwemix uses a custom
...
// gwemix node on the "txpool_content" method.
